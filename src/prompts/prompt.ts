export const INSTRUCTION_REFLECTION_PROMPT = `You are helping an AI agent improve. You can do this by changing their system prompt.
...
export const INSTRUCTION_REFLECTION_MULTIPLE_PROMPT = `You are helping an AI agent improve. You can do this by changing their system prompt.
